...
2. Ensure `names.txt` is in the working directory.
3. Install required libraries: `pip install torch matplotlib ipywidgets scipy numpy`.
4. Open `makemore_part3_bn.ipynb` in Jupyter Notebook or JupyterLab.
